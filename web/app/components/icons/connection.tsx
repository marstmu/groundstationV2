...
const Icon = (props: ComponentProps<any>) => {
    return (
        <svg className={props.className} xmlns="http://www.w3.org/2000/svg" height={props.size} viewBox="0 -960 960 960" width={props.size} fill={props.isConnected ? "#6b7280" : "#ef4444"}>
            {props.isConnected
